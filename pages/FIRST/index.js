      ...
      <div className="lg:mt-16 sm:mt-12 mt-16 flex px-8 lg:flex-row justify-between items-center flex-col lg:gap-8 gap-12">
        <div className="w-full xl:w-5/12 lg:w-6/12">
          ...
          <p className="font-normal text-sm leading-6 text-gray-400 mt-6 text-center">
            ...
            science and technology. His passion and determination to help young
            people discover the excitement and rewards of science and technology
            are the cornerstones of FIRST. FIRST was founded in 1989 to inspire
      ...
      <div className="lg:mt-16 sm:mt-12 mt-16 flex items-center px-8 lg:flex-row justify-between flex-col lg:gap-8 gap-12">
        ...
        <div className="w-full xl:w-5/12 lg:w-6/12">
          <p className="font-normal text-sm leading-6 text-gray-400 mt-6 text-center">
            ...
            to pursue education and career opportunities in science, technology,
            engineering, and math, while building self-confidence, knowledge,
            and life skills.
          </p>
